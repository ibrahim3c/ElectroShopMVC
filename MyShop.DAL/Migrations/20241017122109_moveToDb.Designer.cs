...
namespace MyShop.Web.Migrations
{
    ...
    [Migration("20241017122109_moveToDb")]
    partial class moveToDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyShop.Web.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyShop.Entities.Models.OrderDetails", b =>
                {
                    b.HasOne("MyShop.Web.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("MyShop.Entities.Models.ShoppingCart", b =>
                {
                    ...
                    b.HasOne("MyShop.Entities.Models.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
